    ...
    const menu = (
      <Menu className={styles.menu} selectedKeys={[]} onClick={onMenuClick}>
        <Menu.Item key="userinfo">
          <Icon type="setting" />
          <FormattedMessage
            id="platform.home.menu.account.settings"
            defaultMessage="account settings"
          />
        </Menu.Item>
        <Menu.Item key="logout">
          <Icon type="logout" />
          <FormattedMessage id="platform.home.menu.account.logout" defaultMessage="logout" />
        </Menu.Item>
      </Menu>
    );
        ...
        {currentUser.username ? (
          <HeaderDropdown overlay={menu}>
            <span className={`${styles.action} ${styles.account}`}>
              <Avatar
                size="small"
                className={`${styles.avatar} phip-header-avatar`}
                src={currentUser.avatar ? currentUser.avatar : avatarPng}
                alt="avatar"
              />
